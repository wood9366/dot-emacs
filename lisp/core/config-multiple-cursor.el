(use-package evil-mc
  ...
  (let ((keys '(("ma" . evil-mc-make-all-cursors)
                ("mA" . evil-mc-undo-all-cursors)
                ("mp" . evil-mc-pause-cursors)
                ("mP" . evil-mc-resume-cursors)
                ("mf" . evil-mc-make-and-goto-first-cursor)
                ("ml" . evil-mc-make-and-goto-last-cursor)
                ("mc" . evil-mc-make-cursor-here)
                ("m," . evil-mc-make-cursor-move-next-line)
                ("m." . evil-mc-make-cursor-move-prev-line)
                ("mj" . evil-mc-make-and-goto-next-cursor)
                ("mJ" . evil-mc-skip-and-goto-next-cursor)
                ("mk" . evil-mc-make-and-goto-prev-cursor)
                ("mK" . evil-mc-skip-and-goto-prev-cursor)
    ...
    (dolist (key-data keys)
      (evil-leader/set-key (car key-data) (cdr key-data))))
